  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'dot-pattern': 'radial-gradient(circle, #666 1px, transparent 1px)',
        'shine-pattern': 'linear-gradient(120deg, #00000000 30%, #ffffff20 38%, #ffffff20 40%, #00000000 48%)',
